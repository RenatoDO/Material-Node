...
//This is my change
int32 FHLSLMaterialTranslator::Spectrum(int32 Wavelength, uint8 Spectrum_Type)
{
	if (Wavelength == INDEX_NONE)
	{
		return INDEX_NONE;
	}

	int32 Spectrum_TypeConst = Constant(Spectrum_Type);

	return AddCodeChunk(MCT_Float3, 
		TEXT("MaterialExpressionSpectrum(%s,%s)"), 
		*GetParameterCode(Wavelength),
		*GetParameterCode(Spectrum_TypeConst));
}
