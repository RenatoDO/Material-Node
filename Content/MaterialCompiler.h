...
public:
	...
	//This is my change
	virtual int32 Spectrum(int32 Wavelength, uint8 Spectrum_Type) = 0;
...
public:
	...
	//This is my change
	virtual int32 Spectrum(int32 Wavelength, uint8 Spectrum_Type) override
	{
		return Compiler->Spectrum(Wavelength, Spectrum_Type);
	}
